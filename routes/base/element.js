...
router.post(
  '/setElementProfileSystems/:id',
  ElementController.setElementProfileSystems
);
router.post(
  '/setElementGlassesFolders/:id',
  ElementController.setElementGlassesFolders
);
...
router.get('/getElementConsist/:id', ElementController.getElementConsist);
