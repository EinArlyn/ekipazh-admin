...
/**
 * Add new group's item
 */
module.exports = function (req, res) {
  parseForm(req, function (err, fields, files) {
    if (err) return res.send({ status: false, error: err });

    models.doors_hardware_items.create({
      hardware_group_id: parseInt(fields.hardware_group_id, 10),
      ...
      child_id: parseInt(fields.item_id, 10),
      child_type: fields.item_type,
      position: 0,
      modified: new Date()
