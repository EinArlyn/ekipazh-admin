      ...
      async.parallel([
        function (callback) {
          ...
          models.addition_folders.findAll({
            ...
            attributes: ['max_size', 'position', 'img', 'description', 'link', 'modified', 'factory_id', 'addition_type_id', 'name', 'id']
          }).then(function (addition_folders) {
            var values = [];
            tables.addition_folders = {};
            tables.addition_folders.fields = ['max_size', 'position', 'img', 'description', 'link', 'modified', 'factory_id', 'addition_type_id', 'name', 'id'];
        ...
        function (callback) {
          ...
          models.sequelize.query("SELECT B.id, B.profile_system_id, B.list_id, B.glass_width, B.modified " +
            ...
            "").then(function (beed_profile_systems) {
              ...
              tables.beed_profile_systems.fields = ["id", "profile_system_id", "list_id", "glass_width", "modified"];
        ...
        function (callback) {
          ...
          models.currencies.findAll({
            ...
            tables.currencies = {};
            tables.currencies.fields = ['modified', 'is_base', 'factory_id', 'value', 'name', 'id'];
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'profile_systems' }
          }).then(function (locales_names) {
            tables.locales_names_profile_systems = {};
            tables.locales_names_profile_systems.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
        ...
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'glass_folders' }
          }).then(function (locales_names) {
            tables.locales_names_glass_folders = {};
            tables.locales_names_glass_folders.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'addition_folders' }
          }).then(function (locales_names) {
            tables.locales_names_addition_folders = {};
            tables.locales_names_addition_folders.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'doors_hardware_groups' }
          }).then(function (locales_names) {
            tables.locales_names_doors_hardware_groups = {};
            tables.locales_names_doors_hardware_groups.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'doors_groups' }
          }).then(function (locales_names) {
            tables.locales_names_doors_groups = {};
            tables.locales_names_doors_groups.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_lists.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'lamination_factory_colors' }
          }).then(function (locales_names) {
            tables.locales_names_lamination_factory_colors = {};
            tables.locales_names_lamination_factory_colors.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
              tables.locales_names_lamination_factory_colors.rows = values;
              callback(null);
            });
          });
        },
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'window_hardware_folders' }
          }).then(function (locales_names) {
            tables.locales_names_window_hardware_folders = {};
            tables.locales_names_window_hardware_folders.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
              tables.locales_names_window_hardware_folders.rows = values;
              callback(null);
            });
          });
        },
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_mosquitos.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'mosquitos_singles' }
          }).then(function (locales_names) {
            tables.locales_names_mosquitos_singles = {};
            tables.locales_names_mosquitos_singles.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'window_hardware_groups' }
          }).then(function (locales_names) {
            tables.locales_names_window_hardware_groups = {};
            tables.locales_names_window_hardware_groups.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          /** locales_names */
          models.locales_names.findAll({
            where: { factory_id: factory_id, table_name: 'profile_system_folders' }
          }).then(function (locales_names) {
            tables.locales_names_profile_system_folders = {};
            tables.locales_names_profile_system_folders.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'it', 'pl', 'bg', 'es'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.doors_folders.findAll({
            ...
            models.doors_groups.findAll({
              ...
              attributes: ["rama_sill_list_id", "code_sync_white", "shtulp_list_id", "impost_list_id", "stvorka_list_id", "door_sill_list_id", "rama_list_id", "modified", "name", "folder_id", "factory_id", "id"]
              ...
              tables.doors_groups = {};
              tables.doors_groups.fields = ["rama_sill_list_id", "code_sync_white", "shtulp_list_id", "impost_list_id", "stvorka_list_id", "door_sill_list_id", "rama_list_id", "modified", "name", "folder_id", "factory_id", "id"];
              sortValues(doors_groups, function (values) {
                ...
                models.doors_laminations_dependencies.findAll({
                  ...
                  attributes: ["rama_sill_list_id", "modified", "code_sync", "shtulp_list_id", "impost_list_id", "stvorka_list_id", "door_sill_list_id", "rama_list_id", "lamination_out", "lamination_in", "group_id", "id"]
                }).then(function (doors_laminations_dependencies) {
                  tables.doors_laminations_dependencies = {};
                  tables.doors_laminations_dependencies.fields = ["rama_sill_list_id", "modified", "code_sync", "shtulp_list_id", "impost_list_id", "stvorka_list_id", "door_sill_list_id", "rama_list_id", "lamination_out", "lamination_in", "group_id", "id"];
                  sortValues(doors_laminations_dependencies, function (values) {
                    tables.doors_laminations_dependencies.rows = values;
                    ...
                    models.doors_groups_dependencies.findAll({
                      ...
                      attributes: ["modified", "doors_group_id", "hardware_group_id", "id"]
                    }).then(function (doors_groups_dependencies) {
                      tables.doors_groups_dependencies = {};
                      tables.doors_groups_dependencies.fields = ["modified", "doors_group_id", "hardware_group_id", "id"];
                      sortValues(doors_groups_dependencies, function (values) {
                        tables.doors_groups_dependencies.rows = values;
                        callback(null);
                      });
                    });
                  });
        ...
        function (callback) {
          /** lists */
          models.sequelize.query("SELECT L.id, L.name, L.list_group_id, L.list_type_id, L.a, L.b, L.c, L.d, L.parent_element_id, L.position, L.add_color_id, L.modified, L.addition_folder_id, L.amendment_pruning, L.waste, L.cameras, L.link, L.description, L.img, L.beed_lamination_id, L.in_door, L.doorstep_type, L.glass_type, L.glass_image, L.is_push, L.glass_color " +
            "FROM lists L " +
            "JOIN elements E " +
            "ON L.parent_element_id = E.id " +
            ...
            "").then(function (lists) {
              tables.lists = {};
              tables.lists.fields = ["id", "name", "list_group_id", "list_type_id", "a", "b", "c", "d", "parent_element_id", "position", "add_color_id", "modified", "addition_folder_id", "amendment_pruning", "waste", "cameras", "link", "description", "img", "beed_lamination_id", "in_door", "doorstep_type", "glass_type", "glass_image", "is_push", "glass_color"];
                  ...
                  models.list_contents.findAll({
                    ...
                    sortValues(list_contents, function (values) {
                      ...
                      models.lock_lists.findAll({
                        ...
                        attributes: ['modified', 'group_id', 'list_id', 'id']
                      }).then(function (lock_lists) {
                        tables.lock_lists = {};
                        tables.lock_lists.fields = ['modified', 'accessory_id', 'list_id', 'id'];
        ...
        function (callback) {
          ...
          models.lists_types.findAll()
            .then(function (lists_types) {
              tables.lists_types = {};
              tables.lists_types.fields = ['modified', 'image_add_param', 'name', 'id'];
        ...
        function (callback) {
          ...
          models.options_coefficients.findAll({
            where: { factory_id: factory_id }
          })
            .then(function (options_coefficients) {
              tables.options_coefficients = {};
              tables.options_coefficients.fields = ['piece_currencies', 'piece_price', 'perimeter_currencies', 'perimeter_price', 'area_currencies', 'area_price', 'coeff', 'margin', 'plan_production', 'id', 'factory_id', 'estimated_cost', 'salary_assembly_hrn', 'salary_assembly_hrn_m', 'salary_assembly_percent', 'salary_glass_hrn', 'salary_glass_hrn_m', 'salary_glass_percent', 'rent_production_hrn', 'rent_production_hrn_m', 'rent_production_percent', 'salary_itr_hrn', 'salary_itr_hrn_m', 'salary_itr_percent', 'rent_offices_hrn', 'rent_offices_hrn_m', 'rent_offices_percent', 'salary_manager_hrn', 'salary_manager_hrn_m', 'salary_manager_percent', 'transport_cost_hrn', 'transport_cost_hrn_m', 'transport_cost_percent', 'others_hrn', 'others_hrn_m', 'others_percent', 'rentability_hrn', 'rentability_hrn_m', 'rentability_percent'];
        ...
        function (callback) {
          /** options_discounts */
          models.options_discounts.findAll({
            where: { factory_id: factory_id }
          })
            .then(function (options_discounts) {
              tables.options_discounts = {};
              tables.options_discounts.fields = ['percents', 'week_8', 'week_7', 'week_6', 'week_5', 'week_4', 'week_3', 'week_2', 'week_1', 'base_time', 'standart_time', 'min_time', 'factory_id', 'id'];
        ...
        function (callback) {
          ...
          models.profile_system_folders.findAll({
            ...
            .then(function (profile_system_folders) {
              ...
              tables.profile_system_folders.fields = ['img', 'description', 'link', 'modified', 'position', 'factory_id', 'name', 'id'];
        ...
        function (callback) {
          /** profile_systems */
          models.sequelize.query("SELECT S.id, S.name, S.short_name, S.folder_id, S.rama_list_id, S.rama_still_list_id, S.stvorka_list_id, S.impost_list_id, S.shtulp_list_id, S.is_editable, S.is_default, S.position, S.country, S.modified, S.cameras, S.heat_coeff, S.noise_coeff, S.heat_coeff_value, S.link, S.description, S.img, S.is_push " +
            ...
            "").then(function (profile_systems) {
              var profileSystemsIds = profile_systems[0].map(function (profile) {
                return profile.id
              });
              profileSystemsIds.push(-1);
              tables.profile_systems = {};
              tables.profile_systems.fields = ["id", "name", "short_name", "folder_id", "rama_list_id", "rama_still_list_id", "stvorka_list_id", "impost_list_id", "shtulp_list_id", "is_editable", "is_default", "position", "country", "modified", "cameras", "heat_coeff", "noise_coeff", "heat_coeff_value", "link", "description", "img", "is_push"];
              sortQueries(profile_systems[0], function (values) {
                ...
                models.profile_laminations.findAll({
                  ...
                  attributes: ["id", "profile_id", "lamination_in_id", "lamination_out_id", "rama_list_id", "rama_still_list_id", "stvorka_list_id", "impost_list_id", "shtulp_list_id", "code_sync", "modified"]
                }).then(function (profile_laminations) {
                  tables.profile_laminations = {};
                  tables.profile_laminations.fields = ["id", "profile_id", "lamination_in_id", "lamination_out_id", "rama_list_id", "rama_still_list_id", "stvorka_list_id", "impost_list_id", "shtulp_list_id", "code_sync", "modified"];
                  sortValues(profile_laminations, function (values2) {
                    ...
                    models.mosquitos.findAll({
                      ...
                      tables.mosquitos = {};
                      tables.mosquitos.fields = ['group_id', 'modified', 'cloth_waste', 'cloth_id', 'right_waste', 'right_id', 'top_waste', 'top_id', 'left_waste', 'left_id', 'bottom_waste', 'bottom_id', 'name', 'profile_id', 'id'];
        ...
        function (callback) {
          /** price_koefficients */
          models.sequelize.query("SELECT PK.value, PK.koef_id, PK.element_id, PK.id " +
            ...
            "").then(function (price_koefficients) {
              ...
              tables.price_koefficients.fields = ["value", "koef_id", "element_id", "id"];
        ...
        function (callback) {
          ...
          models.mosquitos_singles.findAll({
            ...
            .then(function (mosquitos_singles) {
              ...
              tables.mosquitos_singles.fields = ['group_id', 'modified', 'cloth_waste', 'cloth_id', 'right_waste', 'right_id', 'top_waste', 'top_id', 'left_waste', 'left_id', 'bottom_waste', 'bottom_id', 'name', 'factory_id', 'id'];
        ...
        function (callback) {
          /** rules_types */
          models.rules_types.findAll()
            .then(function (rules_types) {
              tables.rules_types = {};
              tables.rules_types.fields = ['modified', 'suffix', 'child_unit', 'parent_unit', 'name', 'id'];
        ...
        function (callback) {
          /** templates */
          models.templates.findAll()
            .then(function (templates) {
              tables.templates = {};
              tables.templates.fields = ['template_object', 'icon', 'name', 'group_id', 'id'];
        ...
        function (callback) {
          /** template_groups */
          models.template_groups.findAll()
        ...
        function (callback) {
          ...
          models.users_discounts.findAll({
            ...
            .then(function (users_discounts) {
              ...
              tables.users_discounts.fields = ['week_8_add_elem', 'week_8_construct', 'week_7_add_elem', 'week_7_construct', 'week_6_add_elem', 'week_6_construct', 'week_5_add_elem', 'week_5_construct', 'week_4_add_elem', 'week_4_construct', 'week_3_add_elem', 'week_3_construct', 'week_2_add_elem', 'week_2_construct', 'week_1_add_elem', 'week_1_construct', 'default_add_elem', 'default_construct', 'max_add_elem', 'max_construct', 'user_id', 'id'];
        ...
        function (callback) {
          ...
          models.deactivated_mountings.findAll({
            ...
            var deactivatedMountingsIds = deactivatedMountings.map(function (mounting) {
            ...
            models.users_mountings.findAll({
              ...
              .then(function (users_mountings) {
                ...
                tables.users_mountings.fields = ['price', 'type', 'name', 'active', 'user_id', 'id'];
        ...
        function (callback) {
          ...
          models.deactivated_deliveries.findAll({
            ...
            var deactivatedDeliveriseIds = deactivatedDeliverise.map(function (delivery) {
              return delivery.delivery_id
            });
            deactivatedDeliveriseIds.push(-1);
            models.users_deliveries.findAll({
              where: { id: { $notIn: deactivatedDeliveriseIds }, user_id: { $in: [userId, factory_id] }, active: 1 }
            })
              .then(function (users_deliveries) {
                tables.users_deliveries = {};
                tables.users_deliveries.fields = ['price', 'type', 'name', 'active', 'user_id', 'id'];
        ...
        function (callback) {
          ...
          models.window_hardware_colors.findAll()
            .then(function (window_hardware_colors) {
              tables.window_hardware_colors = {};
              tables.window_hardware_colors.fields = ['modified', 'name', 'id'];
        ...
        function (callback) {
          ...
          models.window_hardware_folders.findAll({
            ...
            .then(function (window_hardware_folders) {
              ...
              tables.window_hardware_folders.fields = ['modified', 'img', 'description', 'link', 'factory_id', 'name', 'id'];
        ...
        function (callback) {
          ...
          models.sequelize.query("SELECT G.id, G.name, G.short_name, G.is_editable, G.folder_id, G.is_group, G.is_in_calculation, G.position, G.modified, G.link, G.description, G.img, G.producer, G.country, G.heat_coeff, G.noise_coeff, G.is_default, G.min_height, G.max_height, G.min_width, G.max_width, G.is_push " +
            "FROM window_hardware_groups G " +
            "JOIN window_hardware_folders F " +
            "ON G.folder_id = F.id " +
            "WHERE F.factory_id = " + factory_id + " AND G.is_in_calculation = 1" +
            "").then(function (window_hardware_groups) {
              tables.window_hardware_groups = {};
              tables.window_hardware_groups.fields = ["id", "name", "short_name", "is_editable", "folder_id", "is_group", "is_in_calculation", "position", "modified", "link", "description", "img", "producer", "country", "heat_coeff", "noise_coeff", "is_default", "min_height", "max_height", "min_width", "max_width", "is_push"];
        ...
        function (callback) {
          ...
          models.sequelize.query("SELECT PK.constant_value, PK.location, PK.list_id, PK.id " +
            ...
            "").then(function (window_hardware_handles) {
              ...
              tables.window_hardware_handles.fields = ["constant_value", "location", "list_id", "id"];
        ...
        function (callback) {
          ...
          models.window_hardware_types.findAll()
            .then(function (window_hardware_types) {
              tables.window_hardware_types = {};
              tables.window_hardware_types.fields = ['modified', 'short_name', 'name', 'id'];
        ...
        function (callback) {
          /** window_hardwares */
          models.window_hardwares.findAll({
            where: { factory_id: factory_id }
          })
            .then(function (window_hardwares) {
              tables.window_hardwares = {};
              tables.window_hardwares.fields = ["id", "window_hardware_type_id", "min_width", "max_width", "min_height", "max_height", "direction_id", "window_hardware_color_id", "length", "count", "child_id", "child_type", "position", "factory_id", "window_hardware_group_id", "modified"];
        ...
        function (callback) {
          ...
          models.background_templates.findAll({
            ...
            .then(function (background_templates) {
              ...
              tables.background_templates.fields = ['factory_id', 'modified', 'desc_2', 'desc_1', 'template_id', 'group_id', 'position', 'img', 'id'];
        ...
        function (callback) {
          ...
          models.window_hardware_type_ranges.findAll({
            ...
            tables.window_hardware_type_ranges.fields = ['group_id', 'modified', 'min_height', 'max_height', 'min_width', 'max_width', 'type_id', 'factory_id', 'id'];
        ...
        function (callback) {
          ...
          models.doors_hardware_groups.findAll({
            ...
            attributes: ["is_push", "width_min", "width_max", "height_min", "height_max", "type", "modified", "burglar_coeff", "anticorrosion_coeff", "image", "description", "link", "country", "producer", "name", "hardware_type_id", "factory_id", "id"]
          }).then(function (doors_hardware_groups) {
            var doorsHardwareGroupsIds = doors_hardware_groups.map(function (group) {
              return group.dataValues.id;
            });
            doorsHardwareGroupsIds.push(-1);
            tables.doors_hardware_groups = {};
            tables.doors_hardware_groups.fields = ["is_push", "width_min", "width_max", "height_min", "height_max", "type", "modified", "burglar_coeff", "anticorrosion_coeff", "image", "description", "link", "country", "producer", "name", "hardware_type_id", "factory_id", "id"]
            sortValues(doors_hardware_groups, function (values) {
              tables.doors_hardware_groups.rows = values;
              /** doors_hardware_items */
              models.doors_hardware_items.findAll({
                where: {
                  hardware_group_id: {
                ...
                tables.doors_hardware_items.fields = ['id', 'hardware_group_id', 'min_width', 'max_width', 'min_height', 'max_height', 'direction_id', 'hardware_color_id', 'length', 'count', 'child_id', 'position', 'modified', 'child_type'];
        ...
        function (callback) {
          /** categories_sets */
          models.categories_sets.findAll()
            .then(function (categories_sets) {
              tables.categories_sets = {};
              tables.categories_sets.fields = ['id', 'title'];
        ...
        function (callback) {
          ...
          models.sets.findAll()
            .then(function (sets) {
              tables.sets = {};
              tables.sets.fields = ['id', 'categories_sets_id', 'title', 'is_visible', 'img', 'description'];
        ...
        function (callback) {
          /** set_data */
          models.set_data.findAll()
            .then(function (set_data) {
              tables.set_data = {};
              tables.set_data.fields = ['id', 'sets_id', 'profile_systems_id', 'window_hardware_groups_id', 'list_id'];
        ...
        if (err) {
          console.log(err);
          res.send({ status: false, error: 'Failed to Import database.' });
        } else {
