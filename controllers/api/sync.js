    ...
    user.updateAttributes({
      ...
      async.parallel([
        ...
        function (callback) {
          ...
          models.sequelize.query("SELECT a_c.list_type_id, a_c.value " +
          "FROM users " +
          ...
          "").then(function (addition_coefficients) {
            ...
            tables.addition_coefficients.fields = ["list_type_id", "value"];
        ...
        function (callback) {
          /** users_coefficients */
          models.sequelize.query("SELECT p_s.id AS profile_id, u_c.value " +
          "FROM users " +
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_profile_systems.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_glass_folders.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_addition_folders.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_doors_hardware_groups.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_doors_groups.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_lists.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_lamination_factory_colors.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_window_hardware_folders.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_mosquitos.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_mosquitos_singles.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_window_hardware_groups.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          ...
          models.locales_names.findAll({
            ...
            tables.locales_names_profile_system_folders.fields = ['id', 'table_name', 'table_id', 'table_attr', 'ru', 'en', 'ua', 'de', 'ro', 'it', 'pl', 'es', 'bg'];
            sortValues(locales_names, function (values) {
        ...
        function (callback) {
          /** users_markups */
          models.sequelize.query("SELECT max_construct, max_add_elem " +
          "FROM users_markups " +
          "WHERE users_markups.user_id = " + parseInt(userId) +
          "").then(function (users_markups) {
            tables.users_markups = {};
            tables.users_markups.fields = ["max_construct", "max_add_elem"];
