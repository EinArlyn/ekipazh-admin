    ...
    models.pls_elements.findAll({
      ...
      models.pls_links.findAll({
        ...
        profiles.forEach(function (profile) {
          const profileLinks = links.filter(function (link) {
            return link.parent_id === profile.id;
          });

          profile.elements = profileLinks.map(function (link) {
        ...
        res.render('base/shields/grids/profiles', {
          ...
          scriptSrcs: [
            ...
            '/assets/javascripts/base/shields/grids/profiles.js'
          ]
        });
      });
    });
