...
module.exports = function (req, res) {
  parseForm(req, function (err, fields, files) {
    ...
    models.rol_boxes.create({
      ...
      pvc_or_alum_front: parseInt(fields.pvc_or_alum_front, 10) || 0,
      pvc_or_alum_back: parseInt(fields.pvc_or_alum_back, 10) || 0,
      pvc_or_alum_top: parseInt(fields.pvc_or_alum_top, 10) || 0,
      pvc_or_alum_bottom: parseInt(fields.pvc_or_alum_bottom, 10) || 0,
      split_price: Number(fields.split_price) || 0,
      min_width: Number(fields.min_width) || 0,
