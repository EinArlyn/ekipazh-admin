$(function () {
  ...
  $("#add-new-set").click(function (event) {
    ...
    $("#add-new-set-submit").click(function (event) {
      ...
      $.post("/base/element/set/create", {
        ...
        $(".set-link").html('<a href="/base/set/' + data.id + '">' + data.name + '</a>' );
      });
    });
  ...
  */
  ...
  /* Get profile prices */
  $.get('/base/element/getProfilePrices/' + elementId, function (profile_prices) {
    if (profile_prices) {
    ...
    if (glass_prices) {
      switch (glass_prices.table_width) {
        ...
        case 4:
          ...
          $('.secondary, .secondary-1, .tertiary-1, .tertiary, .fourth, .fourth-0').show();
          $('#secondary-0-range').val(glass_prices.col_2_range_1);
          $('#secondary-1-range').val(glass_prices.col_2_range_1);
          $('#secondary-2-range').val(glass_prices.col_2_range_2);
          $('#secondary-value').val(glass_prices.col_2_price);
        ...
        case 5:
          ...
          $('#primary-select').val('1');
          $('#secondary-0-select').val('0');
          $('#secondary-value, #tertiary-value, #fourth-value').css('width', '195px');
          $('.table-glass-price').css('width', '910px');
          $('.secondary, .secondary-1, .tertiary-1, .tertiary, .fourth, .fourth-1, .fifth').show();
          $('#secondary-0-range').val(glass_prices.col_2_range_1);
          $('#secondary-1-range').val(glass_prices.col_2_range_1);
          $('#secondary-2-range').val(glass_prices.col_2_range_2);
          $('#secondary-value').val(glass_prices.col_2_price);
    ...
    $.get('/base/element/getListContents/' + id, function(data) {
      //if (data.length) {
        ...
        for (var j = 0, len2 = eChilds.length; j < len2; j++) {
          if (eChilds[j].list_content.rules_type_id === 3 || eChilds[j].list_content.rules_type_id === 2 || eChilds[j].list_content.rules_type_id === 15 || eChilds[j].list_content.rules_type_id === 4 || eChilds[j].list_content.rules_type_id === 6 || eChilds[j].list_content.rules_type_id === 7 || eChilds[j].list_content.rules_type_id === 8 || eChilds[j].list_content.rules_type_id === 10 || eChilds[j].list_content.rules_type_id === 12 || eChilds[j].list_content.rules_type_id === 13 || eChilds[j].list_content.rules_type_id === 14 || eChilds[j].list_content.rules_type_id === 23 || eChilds[j].list_content.rules_type_id === 24 || eChilds[j].list_content.rules_type_id === 25 || eChilds[j].list_content.rules_type_id === 11) {
            $('<li class="list-element list-content"><a href="/base/element/' + eChilds[j].id + '">' + eChilds[j].name + '</a>' + ' <span class="content-rule">' + parseFloat(eChilds[j].list_content.value) + ' ' + eChilds[j].list_content.rules_type.name.replace('%d ', '').toLowerCase() + '</span></li>').insertAfter('.list-element[data="' + id + '"]');
          } else if (eChilds[j].list_content.rules_type_id === 1) {
            $('<li class="list-element list-content"><a href="/base/element/' + eChilds[j].id + '">' + eChilds[j].name + '</a>' + ' <span class="content-rule">' + eChilds[j].list_content.rules_type.name.replace('%d м', ' ').toLowerCase() + ' ' + parseFloat(eChilds[j].list_content.value) + ' м</span></li>').insertAfter('.list-element[data="' + id + '"]');
          } else if (eChilds[j].list_content.rules_type_id === 5) {
            $('<li class="list-element list-content"><a href="/base/element/' + eChilds[j].id + '">' + eChilds[j].name + '</a>' + ' <span class="content-rule">' + eChilds[j].list_content.rules_type.name.replace('%d кв. м', ' ').toLowerCase() + ' ' + parseFloat(eChilds[j].list_content.value) + ' кв. м</span></li>').insertAfter('.list-element[data="' + id + '"]');
        ...
        for (var k = 0, len3 = lChilds.length; k < len3; k++) {
          if (lChilds[k].list_content.rules_type_id === 3 || lChilds[k].list_content.rules_type_id === 2 || lChilds[k].list_content.rules_type_id === 15 || lChilds[k].list_content.rules_type_id === 4 || lChilds[k].list_content.rules_type_id === 6 || lChilds[k].list_content.rules_type_id === 7 || lChilds[k].list_content.rules_type_id === 8 || lChilds[k].list_content.rules_type_id === 10 || lChilds[k].list_content.rules_type_id === 12 || lChilds[k].list_content.rules_type_id === 13 || lChilds[k].list_content.rules_type_id === 14 || lChilds[k].list_content.rules_type_id === 23 || lChilds[k].list_content.rules_type_id === 24 || lChilds[k].list_content.rules_type_id === 25 || lChilds[k].list_content.rules_type_id === 11) {
            $('<li class="list-element list-content"><a href="/base/set/' + lChilds[k].id + '">' + lChilds[k].name + '</a>' + ' <span class="content-rule">' + parseFloat(lChilds[k].list_content.value) + ' ' + lChilds[k].list_content.rules_type.name.replace('%d ', '').toLowerCase() + '</span></li>').insertAfter('.list-element[data="' + id + '"]');
          } else if (lChilds[k].list_content.rules_type_id === 1) {
            $('<li class="list-element list-content"><a href="/base/set/' + lChilds[k].id + '">' + lChilds[k].name + '</a>' + ' <span class="content-rule">' + lChilds[k].list_content.rules_type.name.replace('%d м', ' ').toLowerCase() + ' ' + parseFloat(lChilds[k].list_content.value) + ' м</span></li>').insertAfter('.list-element[data="' + id + '"]');
          } else if (lChilds[k].list_content.rules_type_id === 5) {
            $('<li class="list-element list-content"><a href="/base/set/' + lChilds[k].id + '">' + lChilds[k].name + '</a>' + ' <span class="content-rule">' + lChilds[k].list_content.rules_type.name.replace('%d кв. м', ' ').toLowerCase() + ' ' + parseFloat(lChilds[k].list_content.value) + ' кв. м</span></li>').insertAfter('.list-element[data="' + id + '"]');
