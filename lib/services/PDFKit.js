    ...
    if (product.is_addelem_only === 2) {
        ...
        <div class="bound">
          ...
          <div class="add-container">
            ...
            <div class="rolet-description">
              ...
              <span class="info-sub-titel">
                ${productTemplate.boxSize.width} ${i18n.__('mm')} (W) x ${productTemplate.boxSize.height} ${i18n.__('mm')} (H)
              </span>
              ...
              `<span class="info-sub-titel">
                ${productTemplate.control.sides.map((s, idx) => `<span>${i18n.__('part')} ${idx+1} - ${s}</span>`).join(' ')}
              </span>` : ''
              }
              ${
                      ...
                      productTemplate.addElems
                        .map(elem => `
                          <div class="info-sub-titel">
                            ...
                            <span>
                              ${elem.rule === 1 ? i18n.__('pcs') : ''}
                              ${elem.rule === 2 ? i18n.__('m') : ''}
                              ${elem.rule === 3 ? i18n.__('sq. m') : ''}
                              ${elem.rule === 4 ? i18n.__('unit_kg') : ''}
                              ${elem.rule === 5 ? i18n.__('mm') : ''}
                              ${elem.rule === 6 ? i18n.__('unit_cm') : ''}
                            </span>
                          </div>
                          `).join(' ')
                    }
              ...
              <div class="info-prod-price">
                <div class="ekipazh-product-count">
                  ...
                  <div class="ekipazh-value"> 
                    ${parseInt(product.product_qty, 10)}  ${i18n.__('pcs')} 
                  </div> 
                </div> 
                <div class="ekipazh-product-Eprice"> 
                  <div class="ekipazh-title"> 
                    ${i18n.__('Price') + ' 1' + i18n.__('pcs')} 
                  </div> 
                  <div class="ekipazh-value"> 
                ...
                <div class="ekipazh-product-Gprice"> 
                  <div class="ekipazh-title"> 
                    ${i18n.__('Price') + ' ' + product.product_qty + ' ' + i18n.__('pcs')} 
                  </div> 
                  <div class="ekipazh-value"> 
      ...
      '<div class="header-product">' +
        ...
        '<div class="product-description" style="margin: 0 auto">' +
          i18n.__('Size') + ': ' + parseInt(product.template_width, 10) +  i18n.__('x') + parseInt(product.template_height, 10) + ' / ' + i18n.__('Area_orders') + ': ' + parseFloat(product.template_square).toFixed(2) + ' / ' + i18n.__('Perimeter') + ' : ' + productPerimeter + ' / ' + i18n.__('Add. elements') + ': ' + addElementsQty + i18n.__('pcs') + ' / ' + (weightConstruction && weightConstruction > 0 ? (i18n.__('Weight (kg)') + ': ' + weightConstruction.toFixed(2)) : '') +
        '</div>' +
      '</div>' +
      '<div class="product">' + 
