...
function writeHistory(userId, model, field, values, parent) {
  ...
  switch (model) {
    case 'add_params':
      ...
      break;
    case 'rights':
      // message, fieldName already declared above
      if (field === 1) {
    ...
    case 'discounts':
      if (field === 'max_construct') {
        message = 'The max. discount on constructions has been changed: ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'max_add_elem') {
        message = 'The max. discount on additional items has been changed: ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'default_construct') {
        message = 'Changed the default discount on designs: ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'default_add_elem') {
        message = 'Changed the default discount on additional items: ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_1_construct') {
        message = 'Changed discount on pending order (1 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_1_add_elem') {
        message = 'Changed discount on pending order (1 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_2_construct') {
        message = 'Changed discount on pending order (2 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_2_add_elem') {
        message = 'Changed discount on pending order (2 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_3_construct') {
        message = 'Changed discount on pending order (3 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_3_add_elem') {
        message = 'Changed discount on pending order (3 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_4_construct') {
        message = 'Changed discount on pending order (4 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_4_add_elem') {
        message = 'Changed discount on pending order (4 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_5_construct') {
        message = 'Changed discount on pending order (5 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_5_add_elem') {
        message = 'Changed discount on pending order (5 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_6_construct') {
        message = 'Changed discount on pending order (6 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_6_add_elem') {
        message = 'Changed discount on pending order (6 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_7_construct') {
        message = 'Changed discount on pending order (7 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_7_add_elem') {
        message = 'Changed discount on pending order (7 week): ' + values.old_value + ' --> ' + values.new_value;
      } else if (field === 'week_8_construct') {
        message = 'Changed discount on pending order (8 week): ' + values.old_value + ' --> ' + values.new_value;
